...
public class DragonFight {
	...
	public static void main(String[] args) {
		...
		// or a kick
		String inputuno = JOptionPane.showInputDialog("do you attack this dragon with a kick or a yell?");
		// 9. If they typed in "yell":
		Random ranGen = new Random();
		if (inputuno.equals("yell")) {
			dragonattack = ranGen.nextInt(11);
			dragonHealth -= dragonattack;
		}

		if (inputuno.equals("kick")) {
			dragonattack = ranGen.nextInt(26);
			dragonHealth -= dragonattack;
		}
		...
		// -- Subtract that number from the dragon's health variable
		dragonattack = ranGen.nextInt(25);
		...
		if (dragonHealth <= 0) {
			JOptionPane.showMessageDialog(null, "Congratulations, you won lots of gold and killed a dragon");
		}
		// -- Tell the user that the dragon is dead and they took a ton of gold!

		// 15. Else
		else {JOptionPane.showMessageDialog(null,"The players health is "+playerHealth); 
